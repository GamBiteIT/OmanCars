<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/cars">
        <icon name="cars" class="mr-2 w-4 h-4" :class="isUrl('cars') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('cars') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Cars</div>
      </Link>
    </div>
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/daily-factures">
        <icon name="factures" class="mr-2 w-4 h-4" :class="isUrl('daily-factures') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('daily-factures') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Daily Factures</div>
      </Link>
    </div>
    <div class="mb-4">
